# Generated by Powerlevel10k configuration wizard on 2025-03-20 at 20:26 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh.
# Wizard options: nerdfont-v3 + powerline, small icons, rainbow, unicode,
# vertical separators, round heads, flat tails, 1 line, sparse, many icons, fluent,
...
() {
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_BACKGROUND=25
  ...
  #   typeset -g POWERLEVEL9K_DIR_WORK_NON_EXISTENT_BACKGROUND=8
